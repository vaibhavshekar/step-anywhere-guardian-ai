        ...
        <div 
          ...
          className={cn(
            ...
            badge.earned 
              ...
              : "border-gray-200 bg-gray-100/50 opacity-60 grayscale"
          )}
        >
          <div 
            className={cn(
              "w-12 h-12 flex items-center justify-center rounded-full mb-3",
              badge.earned ? "badge-glow bg-brand-purple/20" : "bg-gray-200"
            )}
          >
            {badge.icon === 'location' ? (
              <MapPin className={cn("h-6 w-6", badge.earned ? "text-brand-purple" : "text-gray-400")} />
            ) : (
              <MessageSquare className={cn("h-6 w-6", badge.earned ? "text-brand-purple" : "text-gray-400")} />
            )}
          </div>
          ...
          {badge.earned && badge.date && (
            <div className="mt-2 text-xs text-brand-purple flex items-center">
